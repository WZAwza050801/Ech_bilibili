...
PIP_REQUIRED = []
# (import 名, 说明)
PIP_OPTIONAL = [('faster_whisper', '本地 ASR，可用云端转写或复用现成 transcript.json 替代')]
# (命令, 是否必需, 安装提示)
SYS_TOOLS = [('ffmpeg', True, 'apt install ffmpeg / winget install Gyan.FFmpeg / brew install ffmpeg')]
# (环境变量, 是否必需, 用途)
